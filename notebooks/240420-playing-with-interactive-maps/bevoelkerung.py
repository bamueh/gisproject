        ...
        [
            ...
            html.Div(
                [
                    ...
                    html.P(
                        "Due to climate change, the frequency and intensity of heat waves and hot summers increases (Fischer & Knutti, 2015). People older than 65 years, especially older women, and people with cardiovascular diseases are particularly at risk from elevated temperatures (Benmarhnia et al., 2015). Cities tend to heat up more than the surrounding areas, due to built-up areas and blocked air flows (de Almeida et al., 2021). The heat in cities can be mitigated through structural measures such as greening roofs, using light-colored asphalt, or creating green spaces (de Almeida et al., 2021). Due to increased adverse health effects of heat on older people, it might be desirable to take into account not only temperature but also the age structure of the local population when planning and prioritizing such measures.",
                    ),
                    html.P(
                        "The maps on this page give an overview of the temperature in Zürich at selected days in the summer of 2022 (left), and allows the user to interactively explore where areas with high temperatures intersect with areas with a high number of older inhabitants (right)."
                    ),
                ],
                style={
                    "marginLeft": 75,
            ...
            html.Div(
                [
                    ...
                    html.P(
                        "The map below shows the temperature in Zurich during the summer of 2022 extracted from remote sensing data. Use the slider to select the day, or view the temperature averaged across the different days.",
                    ),
                    # Add the map
                    dl.Map(
                        children=[
                ...
                [
                    ...
                    html.P(
                        [
                            ...
                            ". Code for the data pre-processing and implementation of this app is available on GitHub.",
                        ]
                    ),
                    html.H5("References"),
                    html.P(
